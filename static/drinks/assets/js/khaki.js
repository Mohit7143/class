...
function _initVideoBlocks() {
    ...
    $('.nk-plain-video[data-video]:not(.nk-plain-video-enabled)').addClass('nk-plain-video-enabled').each(function () {
        var $plainCont = $(this);
...
function _initQuickView() {
    ...
    $body.on('click', '.nk-portfolio-quick-view, .nk-product-quick-view', function (e) {
        e.preventDefault();
...
function _initAudioPlayer() {
    ...
    */
    ...
    var playlist = [];
    $('ul.nk-audio-playlist:not(.nk-audio-playlist-enabled)').addClass('nk-audio-playlist-enabled').each(function () {
        var _this = this;
...
function _initPluginFlickity() {
    ...
    var $storeCarousel = $('.nk-carousel-1, .nk-carousel-2, .nk-carousel-3').filter('.nk-store:not(.nk-store-carousel-enabled)').addClass('.nk-store-carousel-enabled');
